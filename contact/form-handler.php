...
$use_smtp = '0';
$emailto = 'info@casainolanda.com';

	// retrieve from parameters
	$emailfrom = isset($_POST["email"]) ? $_POST["email"] : "";
	$nocomment = isset($_POST["nocomment"]) ? $_POST["nocomment"] : "";
	$subject = 'Email da Casa in Olanda';
	$message = '';
	$response = '';
...
function sendEmail($subject, $content, $emailto, $emailfrom) {
	...
	$from = $emailfrom;
	$response_sent = '<META HTTP-EQUIV="Refresh" Content="0; URL=http://www.casainolanda.com/successo.html">';
	$response_error = 'Errore, per cortesia riprova o usa un altro metodo per contattarci.';
